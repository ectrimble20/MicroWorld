...
class MapEditorLoadMap(GameScene):
    ...
    def build_gui(self):
        ...
        self.ui_elements['scene_label'] = UILabel(scene_label_rect, "Map Editor Load Map", self.gui,
        ...
        button_rect.centerx = (panel_rect.w // 2) + 100
        self.ui_elements['btn_delete'] = UIButton(button_rect, "Delete Map", self.gui, self.ui_elements['panel'])
